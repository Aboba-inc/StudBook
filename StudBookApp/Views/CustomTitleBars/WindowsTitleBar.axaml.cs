...
namespace StudBookApp.Views.CustomTitleBars
{
    public partial class WindowsTitleBar : UserControl
    {
        ...
        //AvaloniaProperty.Register<WindowsTitleBar, IBrush>(nameof(BackgroundColor), defaultValue: Brushes.White,
        ...
        //    public static readonly DirectProperty<WindowsTitleBar, IBrush> CustomBackgroundProperty =
        //AvaloniaProperty.RegisterDirect<WindowsTitleBar, IBrush>(
        //    nameof(CustomBackground),
        //    o => o.CustomBackground,
        //    (o, v) => o.CustomBackground = v);

        //    private IBrush _customBackground = Brushes.White;

        //    public IBrush CustomBackground
        //    {
        //        get { return _customBackground; }
        //        set { SetAndRaise(CustomBackgroundProperty, ref _customBackground, value); }
        //    }

        //public static readonly StyledProperty<IBrush?> CustomBackgroundProperty =
        //WindowsTitleBar.BackgroundProperty.AddOwner<DockPanel>();

        //public IBrush? CustomBackground
        //{
        //    get { return GetValue(CustomBackgroundProperty); }
        //    set
        //    {
